        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-start">
          ...
          <div ref={bioRef} className="lg:pt-10">
            <p className="font-sans text-base lg:text-lg text-gray-primary leading-relaxed mb-6">
              I'm Sushant Shakya, a passionate Computer Science student and Frontend Developer based in Patan, Nepal.
              I specialize in creating intuitive, pixel-perfect interfaces that bridge the gap between design and development.
            </p>
